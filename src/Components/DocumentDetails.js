...
import DocumentDetailsSingle from './DocumentDetailsSingle';
...
// const DocumentDetails = ({x})=>{
 function DocumentDetails() {
    ...
    //   useEffect(() => {
    //     fetchSigmadocdetails(); // Fetch the monthly data
    //   }, []);
      
    //   const fetchSigmadocdetails = async () => {
    // //    console.log("start",postDetails[0].sigmaId)
    //     //   const id = "543609ec-58ba-4f50-9757-aaf149e5f187";
    //       const [check, data] = await fetchSigmadocdetails(postDetails[0].sigmaId);
    //       console.log("valid1", data);
    ...
    //   useEffect(() => {
    //     fetchSigmadocdetails(sigmaId)
    //       .then(response => {
    //         const [success, data] = response;
    //         if (success) {
    //           setDocumentDetails(data);
    //           console.log("data",documentDetails)
    //         } else {
