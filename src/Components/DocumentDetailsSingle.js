...
const DocumentDetailsSingle= (props)=>{
    ...
    //     else{
    //     let getalgo=location.state.allData.sigmaId
    //      console.log("str",getalgo);
    //       }        
    // }      
    ...
    // useEffect(()=>{fetchSigmadocdetails(location.state.allData.sigmaId)
    // },[]);
    //       const fetchSigmadocdetails=async()=>{
    //           //console.log("inside dbcallalgo function")  
    //           let req = [];
    ...
    //           }
    //           else{
    //             let data = location.state.allData.sigmaId
    //       fetchSigmadocdetails()
    //         .then(response => {
    //           const [success, data] = response;
    //           if (success) {
    //             setDocumentDetails(data);
